...
class Home extends React.Component{
    ...
    render(){
        ...
        <div className='home-container'>
            ...
            <div  data-aos='fade-up' data-aos-anchor-placement="top-center" className='pace-container-1' id='start'>
            ...
            <div className='latest-stories-container'>
                <h1 data-aos='fade-up' data-aos-anchor-placement="top-center">LATEST STORIES</h1>
